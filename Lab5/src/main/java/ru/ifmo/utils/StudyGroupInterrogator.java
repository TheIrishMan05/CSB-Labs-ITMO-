...
public class StudyGroupInterrogator {
    ...
    public Person askPerson() throws IncorrectScriptInputException {
        ...
        int lowBound = (int) LocalDate.of(2006, Month.JANUARY, 1).toEpochDay();
        int upBound = (int) LocalDate.of(1999, Month.APRIL, 10).toEpochDay();
        Random random = new Random();
        long randomDay = lowBound + random.nextInt(lowBound - upBound);
